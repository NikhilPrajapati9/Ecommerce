  ...
  return (
    ...
    <form className='bg-white px-5'>
      ...
      {addresses.map((address) => (
        <li key={address.phone} className="flex justify-between gap-x-6 py-2 mb-3 border-solid border-2 border-gray-200 px-4 shadow-inner rounded-lg">
          <div className="flex min-w-0 gap-x-4">
          <input
                    id={address.phone}
                    name="address"
                    type="radio"
                    className="h-4 mt-6 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                  />
    ...
    <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
      <h1 className='text-4xl font-bold tracking-tight text-gray-700' >Cart</h1>
